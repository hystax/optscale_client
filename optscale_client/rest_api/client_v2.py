...
class Client(Client_v1):
    ...
    def context_get(self, type, uuid):
        url = self.context_url() + self.query_url(type=type, uuid=uuid)
        return self.get(url)
    ...
    def cloud_account_get(self, cloud_account_id, details=False):
        url = self.cloud_account_url(cloud_account_id) + self.query_url(details=details)
        return self.get(url)
    ...
    def employee_list(
        self, org_id, current_only=None, roles=False, exclude_myself=False, fields=None
    ):
        query_params = {"roles": roles, "exclude_myself": exclude_myself}
        if current_only:
            query_params["current_only"] = current_only
        if fields:
            query_params["field"] = fields
        return self.get(
            self.employee_url(org_id=org_id) + self.query_url(**query_params)
        )
    ...
    def cloud_resource_bulk_url(cloud_account_id):
        return "%s/cloud_resources/bulk" % Client.cloud_account_url(cloud_account_id)

    def cloud_resource_create(self, cloud_account_id, params):
        return self.post(
            self.cloud_resource_url(cloud_account_id=cloud_account_id), params
        )

    def cloud_resource_create_bulk(
        self,
        cloud_account_id,
        params,
    ...
    def cloud_resource_get(self, cloud_resource_id, details=False):
        url = self.cloud_resource_url(cloud_resource_id) + self.query_url(
            details=details
        )
        return self.get(url)
    ...
    def report_import_list(self, cloud_account_id, show_completed=False):
        return self.get(
            self.report_import_url(cloud_account_id=cloud_account_id) + self.query_url(show_completed=show_completed)
        )
    ...
    def pool_breakdown_expenses_get(
        self, pool_id, start_date, end_date, filter_by=None
    ):
    ...
    def cloud_expenses_get(self, cloud_acc_id, start_date, end_date, filter_by=None):
    ...
    def employee_expenses_get(self, employee_id, start_date, end_date, filter_by=None):
    ...
    def assignment_create(self, organization_id, params):
        return self.post(self.assignment_url(organization_id=organization_id), params)

    def assignment_list(self, organization_id):
        return self.get(self.assignment_url(organization_id=organization_id))
    ...
    def assignment_request_create(self, organization_id, params):
        return self.post(
            self.assignment_requests_url(organization_id=organization_id), params
        )
    ...
    def assignment_request_decline(self, id):
        return self.patch(self.assignment_request_url(id=id), {"action": "decline"})

    def assignment_request_cancel(self, id):
        return self.patch(self.assignment_request_url(id=id), {"action": "cancel"})

    def cloud_resources_discover(
        self,
        organization_id,
        resource_type,
        filters=None,
    ...
    def split_resources(self, organization_id, resource_ids):
        return self.post(
            self.split_resources_request_url(organization_id=organization_id),
            resource_ids,
        )
    ...
    def assignment_bulk(self, organization_id, params):
        return self.post(
            self.assignment_bulk_url(organization_id=organization_id), params
        )
    ...
    def assignment_request_bulk(self, organization_id, params):
        return self.post(
            self.assignment_request_bulk_url(organization_id=organization_id), params
        )
    ...
    def raw_expenses_get(self, resource_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.raw_expenses_url(resource_id) + self.query_url(**query_params)
        return self.get(url)
    ...
    def bulk_call_aws_url(self, cloud_account_id):
        return "{}/bulk_call_aws".format(self.cloud_account_url(cloud_account_id))
    ...
    def clean_expenses_get(self, organization_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.clean_expenses_url(organization_id) + self.query_url(**query_params)
        return self.get(url)
    ...
    def summary_expenses_get(self, organization_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.summary_expenses_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def rules_list(
        self, organization_id, pool_id=None, owner_id=None, valid_rules_only=None
    ):
    ...
    def resource_limit_hits_list(self, resource_id):
        return self.get(self.resource_limit_hits_url(resource_id=resource_id))
    ...
    def resource_constraint_delete(self, constraint_id):
        return self.delete(self.resource_constraint_url(constraint_id=constraint_id))
    ...
    def optimization_data_url(organization_id):
        return "%s/optimization_data" % Client.organization_url(organization_id)

    def optimization_data_get(
        self,
        organization_id,
        type=None,
        status=None,
    ...
    def discovery_info_url(discovery_info_id=None, cloud_account_id=None):
        ...
        if cloud_account_id is not None:
            url = "%s/%s" % (Client.cloud_account_url(id=cloud_account_id), url)
        return url
    ...
    def discovery_info_update(self, discovery_info_id, params):
        return self.patch(
            self.discovery_info_url(discovery_info_id=discovery_info_id), params
        )

    def discovery_info_bulk_url(self, cloud_account_id):
        return "%s/bulk" % self.discovery_info_url(cloud_account_id=cloud_account_id)
    ...
    def discovery_info_delete_bulk(self, cloud_account_id, discovery_info_ids):
        ...
        return self.delete(
            self.discovery_info_bulk_url(cloud_account_id=cloud_account_id), body
        )

    def discovery_info_switch_enable_url(self, cloud_account_id):
        return "%s/%s" % (
            Client.cloud_account_url(id=cloud_account_id),
            "switch_enable",
        )

    def discovery_info_switch_enable(self, cloud_account_id, resource_type, enabled):
        return self.patch(
            self.discovery_info_switch_enable_url(cloud_account_id=cloud_account_id),
            {"resource_type": resource_type, "enabled": enabled},
        )

    @staticmethod
    def cleanup_scripts_url(cloud_account_id, module_name):
        return "%s/cleanup_%s.sh" % (
            Client.cloud_account_url(cloud_account_id),
            module_name,
        )
    ...
    def rules_apply(self, organization_id, pool_id=None, include_children=None):
        body = {
            "pool_id": pool_id,
    ...
    def resource_optimization_update(self, resource_id, recommendation, action):
        return self.patch(
            self.resource_optimization_url(resource_id),
            {"action": action, "recommendation": recommendation},
        )

    def resource_optimization_dismiss(self, resource_id, recommendation):
        return self.resource_optimization_update(resource_id, recommendation, "dismiss")
    ...
    def organizations_overview_list(self, details=False):
        url = self.organizations_overview_url() + self.query_url(details=details)
        return self.get(url)
    ...
    def cluster_type_priority_update(self, cluster_type_id, action):
        return self.patch(
            self.cluster_type_priority_url(cluster_type_id), {"action": action}
        )
    ...
    def cluster_type_deprioritize(self, cluster_type_id):
        return self.cluster_type_priority_update(cluster_type_id, "deprioritize")
    ...
    def pool_expenses_export_data_get(self, export_id, start_date=None, end_date=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        url = self.pool_expenses_export_data_url(export_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def node_create_bulk(self, cloud_account_id, params):
        return self.post(self.node_bulk_url(cloud_account_id=cloud_account_id), params)
    ...
    def resource_metrics_get(self, resource_id, query_params):
        url = self.metric_url(resource_id=resource_id) + self.query_url(**query_params)
        return self.get(url)
    ...
    def cloud_account_cost_model_update(self, cost_model_id, params):
        return self.patch(self.cloud_account_cost_model_url(cost_model_id), params)
    ...
    def resource_cost_model_update(self, cost_model_id, params):
        return self.patch(self.resource_cost_model_url(cost_model_id), params)
    ...
    def environment_resource_create(self, organization_id, params):
        return self.post(
            self.environment_resource_url(organization_id=organization_id), params
        )

    def environment_resource_get(self, environment_resource_id, details=False):
        url = self.environment_resource_url(environment_resource_id) + self.query_url(
            details=details
        )
        return self.get(url)
    ...
    def environment_resource_update(self, environment_resource_id, params):
        return self.patch(
            self.environment_resource_url(environment_resource_id), params
        )

    def environment_resource_delete(self, environment_resource_id):
        return self.delete(self.environment_resource_url(environment_resource_id))
    ...
    def shareable_book_create(self, organization_id, params):
        return self.post(
            self.shareable_book_collection_url(organization_id=organization_id), params
        )
    ...
    def shareable_book_get(self, item_id):
        return self.get(self.shareable_book_item_url(item_id=item_id))

    def shareable_book_release(self, item_id, params):
        return self.patch(self.shareable_book_item_url(item_id=item_id), params)

    def shareable_book_delete(self, item_id):
        return self.delete(self.shareable_book_item_url(item_id=item_id))
    ...
    def shareable_resources_list(self, organization_id, params=None):
        url = self.shareable_resources_list_url(organization_id=organization_id)
        if params:
            url += self.query_url(**params)
        return self.get(url)
    ...
    def env_properties_send(self, cloud_resource_id, properties):
        return self.post(
            self.env_properties_collector_url(cloud_resource_id), body=properties
        )
    ...
    def env_properties_history_get(
        self, cloud_resource_id, start_date=None, end_date=None
    ):
        query_params = {"start_date": start_date, "end_date": end_date}
        url = self.env_properties_history_url(cloud_resource_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def calendar_synchronization_update(self, calendar_synchronization_id, params):
        return self.patch(
            self.calendar_synchronizations_url(calendar_synchronization_id), params
        )

    def calendar_synchronization_delete(self, calendar_synchronization_id):
        return self.delete(
            self.calendar_synchronizations_url(calendar_synchronization_id)
        )
    ...
    def authorized_employees_url(organization_id):
        return "%s/authorized_employees" % Client.organization_url(organization_id)

    def authorized_employee_list(
        self, organization_id, object_type, object_id, permissions
    ):
        query_params = {
        ...
        url = self.authorized_employees_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def code_report_upload_url(organization_id):
        return "%s/code_report_upload" % Client.organization_url(organization_id)
    ...
    def submit_for_audit_url(organization_id):
        return "%s/submit_for_audit" % Client.organization_url(organization_id)
    ...
    def jira_issue_attachment_list(self, org_id, client_key, project_key, issue_number):
        query_params = {
        ...
        return self.get(
            self.jira_issue_attachment_url(
                org_id=org_id) + self.query_url(**query_params)
        )
    ...
    def download_audit_result(self, organization_id, audit_id):
        return self.get(self.download_audit_result_url(organization_id, audit_id))

    @staticmethod
    def resources_count_url(organization_id):
        return "%s/resources_count" % Client.organization_url(organization_id)

    def resources_count_get(
        self, organization_id, start_date, end_date, breakdown_by=None, params=None
    ):
        query_params = {
            "start_date": start_date,
            "end_date": end_date,
        ...
        if params:
            query_params.update(params)
        url = self.resources_count_url(organization_id) + self.query_url(**query_params)
        return self.get(url)
    ...
    def available_filters_get(self, organization_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.available_filters_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def breakdown_expenses_url(organization_id):
        return "%s/breakdown_expenses" % Client.organization_url(organization_id)

    def breakdown_expenses_get(
        self, organization_id, start_date, end_date, breakdown_by=None, params=None
    ):
        query_params = {"start_date": start_date, "end_date": end_date}
        if breakdown_by:
        ...
        if params:
            query_params.update(params)
        url = self.breakdown_expenses_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def organization_constraint_create(self, org_id, params):
        return self.post(self.organization_constraint_url(org_id=org_id), params)
    ...
    def organization_constraint_update(self, constraint_id, params):
        return self.patch(self.organization_constraint_url(constraint_id), params)
    ...
    def organization_limit_hit_create(self, org_id, params):
        return self.post(self.organization_limit_hit_url(org_id=org_id), params)
    ...
    def organization_limit_hit_update(self, hit_id, params):
        return self.patch(self.organization_limit_hit_url(hit_id), params)

    @staticmethod
    def breakdown_tags_url(organization_id):
        return "%s/breakdown_tags" % Client.organization_url(organization_id)

    def breakdown_tags_get(self, organization_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.breakdown_tags_url(organization_id) + self.query_url(**query_params)
        return self.get(url)
    ...
    def traffic_processing_task_create(self, cloud_account_id, params):
        return self.post(
            self.traffic_processing_task_url(cloud_account_id=cloud_account_id), params
        )

    def traffic_processing_task_list(self, cloud_account_id):
        url = self.traffic_processing_task_url(cloud_account_id=cloud_account_id)
        return self.get(url)
    ...
    def traffic_expenses_get(self, organization_id, start_date, end_date, params=None):
        query_params = {"start_date": start_date, "end_date": end_date}
        if params:
            query_params.update(params)
        url = self.traffic_expenses_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def archived_recommendations_count_get(
        ...
        if params:
            query_params.update(params)
        url = self.archived_recommendations_count_url(organization_id) + self.query_url(
            **query_params
        )
        return self.get(url)
    ...
    def executors_breakdown_url(organization_id):
        return "%s/executors_breakdown" % Client.organization_url(organization_id)
    ...
    def application_get(self, organization_id, application_id):
        return self.get(self.applications_url(organization_id, application_id))
    ...
    def application_delete(self, organization_id, application_id):
        return self.delete(self.applications_url(organization_id, application_id))
    ...
    def goal_delete(self, organization_id, goal_id):
        return self.delete(self.goals_url(organization_id, goal_id))

    def executor_list(self, organization_id, application_ids=None, run_ids=None):
    ...
    def executors_breakdown_get(self, organization_id, breakdown_by):
        url = self.executors_breakdown_url(organization_id) + self.query_url(
    ...
    def run_list(self, organization_id, application_id, **kwargs):
        url = self.runs_url(
            organization_id, application_id=application_id
        ) + self.query_url(**kwargs)
        return self.get(url)

    def application_optimizations_get(
        self, organization_id, application_id, types=None, status=None
    ):
        url = self.application_optimizations_url(organization_id, application_id)
        query_params = {}
        if types is not None:
            query_params["type"] = types
        if status is not None:
    ...
    def risp_processing_task_create(self, cloud_account_id, params):
        return self.post(
            self.risp_processing_task_url(cloud_account_id=cloud_account_id), params
        )
    ...
    def ri_sp_usage_breakdown_url(self, organization_id):
        return "%s/ri_sp_usage_breakdown" % self.organization_url(organization_id)

    def ri_sp_usage_breakdown_get(self, organization_id, **kwargs):
        url = self.ri_sp_usage_breakdown_url(organization_id) + self.query_url(**kwargs)
        return self.get(url)

    def ri_sp_expenses_breakdown_url(self, organization_id):
        return "%s/ri_sp_expenses_breakdown" % self.organization_url(organization_id)
    ...
    def templates_overview_url(organization_id):
        return "%s/templates_overview" % Client.organization_url(organization_id)
    ...
    def template_update(self, organization_id, template_id, params):
        return self.patch(self.templates_url(organization_id, template_id), params)
    ...
    def runset_create(self, organization_id, template_id, params):
        return self.post(
            self.template_runsets_url(organization_id, template_id), params
        )

    def runset_update(self, organization_id, runset_id, params):
        return self.patch(self.runsets_url(organization_id, runset_id), params)
    ...
    def runset_list(self, organization_id, template_id):
        return self.get(self.template_runsets_url(organization_id, template_id))
    ...
    def bi_create(self, org_id, type_: str, name: str = None, days: int = 180, **meta):
        body = {"type": type_, "days": days}
        if name:
            body["name"] = name
        if meta:
            body["meta"] = meta
